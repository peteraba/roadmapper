...
func TestIntegration_Repository(t *testing.T) {
	...
	baseRepo, reset, teardown := testutils.SetupRepository(t, "TestIntegration_Repository", iDbUser, iDbPass, iDbName, nil)
	defer teardown()
	...
	t.Run("InTx", func(t *testing.T) {
		...
		for _, tt := range tests {
			t.Run(tt.name, func(t *testing.T) {
				defer reset()
				logger, buf := testutils.SetupTestLogger()
				baseRepo.Logger = logger
