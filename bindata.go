...
func migrations01_initSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/01_init.sql", size: 583, mode: os.FileMode(0644), modTime: time.Unix(1586696858, 0)}
...
func templatesIndexHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/index.html", size: 9231, mode: os.FileMode(0644), modTime: time.Unix(1586696858, 0)}
